<template>
  <div class="indexPage">
    <div class="chaxun" :style="{ width: cxdivwidth + '%' }">
      ...
      <el-tabs model-value="first" v-model="activeName" @tab-click="tabClick">
    ...
    />
        ...
        <el-tab-pane label="修改信息" name="second">
          ...
          <el-button type="primary" @click="showall" v-if="cxButtonShow">查询</el-button>
          ...
          >
            <div id="editMingxi" v-if="editMingxi">
              <el-table :data="editFormData.array" style="width: 100%">
    <el-table-column prop="zhoushu" width="120" />
    <el-table-column prop="zhouji" width="120" />
    <el-table-column prop="ks_shijian"  label="开始时间" width="120"/>
    <el-table-column prop="js_shijian" label="结束时间" width="120"/>
  ...
  setup() {
    ...
    function showall() {
      ...
      axios.post("/api/editanddeleteinfo", toRaw(editForm)).then((response) => {
        response.data.forEach(elementit => {
          ...
          switch(elementit.zhoushu){
            case 1:
            elementit.zhoushu = '第一周'
            break
            case 2:
            elementit.zhoushu = '第二周'
            break
            case 3:
            elementit.zhoushu = '第三周'
            break
            case 4:
            elementit.zhoushu = '第四周'
            break
            case 5:
            elementit.zhoushu = '第五周'
            break
            case 6:
            elementit.zhoushu = '每周'
            break
          }
        });       
